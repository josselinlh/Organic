...
var product ="<div class='productGallery'><img class='img-circle img-responsive' src='img/carrots.jpg' /><div class='productGalleryToggleButton'><i class='fa fa-cart-arrow-down fa-lg'></i><i class='fa fa-info-circle fa-lg'></i></div></div><div class='productGallery'><img class='img-circle img-responsive' src='img/potatoes.jpg' /><div class='productGalleryToggleButton'><i class='fa fa-cart-arrow-down fa-lg'></i><i class='fa fa-info-circle fa-lg'></i></div></div><div class='productGallery'><img class='img-circle img-responsive' src='img/soup.jpg' /><div class='productGalleryToggleButton'><i class='fa fa-cart-arrow-down fa-lg'></i><i class='fa fa-info-circle fa-lg'></i></div></div><div class='productGallery'><img class='img-circle img-responsive' src='img/cucumbers.jpg' /><div class='productGalleryToggleButton'><i class='fa fa-cart-arrow-down fa-lg'></i><i class='fa fa-info-circle fa-lg'></i></div></div>";

var Articles = [new ArticleMetro("Où nous trouver?", organicMap[0],0),
