...
var product ="<div name='9443' class='productGallery'><img class='img-circle img-responsive' src='img/carrots.jpg' /><div class='productGalleryToggleButton'><p class='prixProduct'>1,20 € / kg</p><i class='fa fa-cart-arrow-down fa-lg'></i><i class='fa fa-info-circle fa-lg'></i></div></div><div name='5990' class='productGallery'><img class='img-circle img-responsive' src='img/potatoes.jpg' /><div class='productGalleryToggleButton'><p class='prixProduct'>1,30 € / kg</p><i class='fa fa-cart-arrow-down fa-lg'></i><i class='fa fa-info-circle fa-lg'></i></div></div><div name='6903' class='productGallery'><img class='img-circle img-responsive' src='img/soup.jpg' /><div class='productGalleryToggleButton'><p class='prixProduct'>3,00 € / kg</p><i class='fa fa-cart-arrow-down fa-lg'></i><i class='fa fa-info-circle fa-lg'></i></div></div><div name='8554' class='productGallery'><img class='img-circle img-responsive' src='img/betterave.jpg' /><div class='productGalleryToggleButton'><p class='prixProduct'>1,50 € / kg</p><i class='fa fa-cart-arrow-down fa-lg'></i><i class='fa fa-info-circle fa-lg'></i></div></div><div name='6417' class='productGallery'><img class='img-circle img-responsive' src='img/chou.jpg' /><div class='productGalleryToggleButton'><p class='prixProduct'>1,50 € / kg</p><i class='fa fa-cart-arrow-down fa-lg'></i><i class='fa fa-info-circle fa-lg'></i></div><script type='text/javascript' src='js/products.js'></script>";
